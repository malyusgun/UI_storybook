...
const gentleIconsEntries = Object.entries(gentleIcons);
</script>

<template>
  <div>
    <h2 class="subtitle"><span class="mono">Mono</span> icons</h2>
    <ul class="iconsList">
      <li class="iconsItem" v-for="icon of gentleIconsEntries" :key="icon[0]">
        <component :is="icon[1]" class="icon" color="white" size="30" />
